...
knitr::opts_knit$set(root.dir = 'atig2025/PCA/'). # you can also set another working directory, such as '~/'.
```
...
```{r}
plink2 <- download_plink2("data", ARM = TRUE, AVX2 = FALSE) #Mac ARM architecture
#plink2 <- download_plink2("data") #PCs, old MACs
rel <- snp_plinkKINGQC(
  plink2.path = plink2,
  bedfile.in = bedfile,
  thr.king = 2^-4.5,
